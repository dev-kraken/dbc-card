...
const ListingCardModal = ({
    ...
    const form = useForm<formSchema>({
        ...
        defaultValues: {
            ...
            yearBuilt: "2002",
            countryId: "US",
            description: "i am selling this house",
            cardId: cardId,
        },
    });
                            ...
                            <div className="flex flex-1 gap-2 col-span-5">
                                {listingImgSrc.map((src, index) => (
                                    ...
                                    >
                                        ...
                                        />
                                        <div
                                            className="absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center bg-black/70 rounded w-full h-auto opacity-0 group-hover:opacity-100 transition-opacity delay-100 duration-300">
                                            <Trash
